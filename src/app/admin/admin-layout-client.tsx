      ...
      <aside className="hidden w-64 flex-shrink-0 border-r border-gray-200 bg-white lg:block">
        <div className="flex h-full flex-col">
          ...
          <div className="flex h-16 items-center gap-3 border-b border-gray-100 px-6">
            ...
            <div>
              <p className="text-sm font-semibold text-gray-900">Kaplan Okulları</p>
      ...
      <div className="flex flex-1 flex-col">
        <header className="flex h-16 items-center justify-between border-b border-gray-200 bg-white px-4 lg:hidden">
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm font-semibold text-gray-900">Kaplan Okulları</span>
          </div>
        ...
        {/* Mobile Navigation */}
        <nav className="flex border-b border-gray-200 bg-white px-2 lg:hidden overflow-x-auto">
          {navItems.map((item) => {
            const isActive =
              item.href === "/admin"
                ? pathname === "/admin"
        ...
        {/* Content */}
        <main className="flex-1 bg-gray-50/50 p-4 md:p-6 lg:p-8">
          {children}
        </main>
      </div>
    </div>
